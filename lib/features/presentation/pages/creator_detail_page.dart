...
class CreatorDetailPage extends StatefulWidget {
  final int id;
  final String title;
  const CreatorDetailPage({super.key, required this.id, required this.title});
...
class _CreatorDetailPageState extends State<CreatorDetailPage> {
  ...
  void initState() {
    super.initState();
    context.read<HomeCreatorCubit>().getDetailCreatorGames(widget.id);
  }
  ...
  Widget _buildBody(HomeCreatorState state) {
