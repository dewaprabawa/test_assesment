...
class _ContentGameListWidgetState extends State<ContentGameListWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: BlocConsumer<HomeGameCubit, HomeGameState>(
          ...
          builder: (context, state) {
            return switch (cubit.state) {
              ...
              HomeGameLoaded(games: var items) => _buildContent(context, items)
            };
          },
        ));
  }

  Padding _buildContent(BuildContext context, List<GameData> items) {
    return Padding(
